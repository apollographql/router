...
In 1.x, invalid values in the CORS configuration, such as malformed regexes, were ignored with an error logged.
In 2.x, such values prevent router startup.

If your router 2.x does not start with an error message like this:
