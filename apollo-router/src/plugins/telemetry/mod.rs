    ...
    fn default() -> Self {
        Self {
            counts: CountMinSketch::new(
                0.001, // probability calculate k_num
                0.001, // error tolerance to calculate width
                (),
            ),
            distinct_entities: HyperLogLog::new(0.001),
            low_frequency_entities: HyperLogLog::new(0.001),
            requests: 0,
        }
    }
}
