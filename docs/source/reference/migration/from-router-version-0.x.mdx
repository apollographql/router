...
* Propagating headers to subgraphs via `RemoteGraphQLDataSource`
    * In the router, you can use the [`headers` option](/router/configuration/header-propagation).
...
The router provides [similar functionality](/router/customizations/rhai-api/#requestcontext).
...
* [Rhai scripts](/router/customizations/rhai/)
