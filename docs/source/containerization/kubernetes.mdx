...
<ExpansionPanel title="Click to expand example values for router v1.31.0">
...
<ExpansionPanel title="Example router Helm values for common configuration across environments">
...
You can install the router chart from either a local repository or the Apollo container registry.
