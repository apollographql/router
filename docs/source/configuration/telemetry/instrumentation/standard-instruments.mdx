...
description: Instruments that are to Apollo Router
---


## Standard instruments

The Apollo Router provides a set of standard instruments that are non-configurable exposing detailed information about the Router's request lifecycle.
These instruments can be consumed by setting via [metrics exporter](../exporters/metrics/overview).
