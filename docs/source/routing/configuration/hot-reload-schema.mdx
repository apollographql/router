...
You can tune this behavior with the `reload` configuration section:
...
reload:
  ...
  # Base delay between retry attempts. A random jitter of up to 25%
  # is added to spread retries across multiple router instances.
  # Default: 10s
  retry_delay: 10s
```
