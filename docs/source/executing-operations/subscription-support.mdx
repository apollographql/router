...
1. Each package that makes up Apollo Federation needs to be updated to version 2.4 or later:
    - `@apollo/gateway`
...
1. [Update your Apollo Server instances to version 4 or later](/apollo-server/migration).
