...
description: Enable and configure the Zipkin exporter for tracing in the Apollo GraphOS Router.
---
...
Enable and configure the [Zipkin](https://zipkin.io/) exporter for tracing in the GraphOS Router.
