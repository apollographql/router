...
**In Apollo Router v2.12.0 and earlier, these variables take precedence over Router telemetry settings and may cause traces or metrics to be sent to an unintended destination.

**In Apollo Router v2.13.0 and later, router will **not** start if any of these variables are set.**
