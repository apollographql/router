...
limits:
  subgraph:
    all:
      http_max_response_size: 10485760 # 10 MB for all subgraphs
    subgraphs:
      products:
        http_max_response_size: 20971520 # 20 MB override for 'products'
```
...
limits:
  connector:
    all:
      http_max_response_size: 5242880 # 5 MB for all connector sources
    sources:
      products.rest:
        http_max_response_size: 10485760 # 10 MB override for 'products.rest'
```
