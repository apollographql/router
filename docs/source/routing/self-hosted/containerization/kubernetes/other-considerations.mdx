...
* [Using the Apollo GraphOS Operator](#using-the-apollo-graphos-operator)
...
## Using the Apollo GraphOS Operator

  For more advanced Kubernetes deployments, consider using the [Apollo GraphOS Operator](https://www.apollographql.com/docs/apollo-operator/) to manage your router and subgraph lifecycle. The Operator provides declarative Kubernetes resources for managing supergraphs and can simplify complex multi-service
  architectures.

  The Operator offers different [workflow patterns](https://www.apollographql.com/docs/apollo-operator/workflows/) depending on your infrastructure:
