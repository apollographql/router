...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.0.0-alpha.6
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.0.0-alpha.6 --values my-values.yaml
```
