...
You can configure which HTTP headers the Apollo Router includes in its requests to each of your subgraphs. You can define header rules for individual subgraphs, along with rules that apply to _all_ subgraphs.
