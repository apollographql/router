...
You can include include GraphQL operations in your telemetry by instrumenting custom [`events` in the supergraph service](/graphos/reference/router/telemetry/instrumentation/events#event-configuration) like so:
