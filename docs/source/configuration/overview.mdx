...
See [Sending HTTP headers to subgraphs](/router/configuration/header-propagation/).
...
In the future, the `generate_query_fragments` option will be the only option for handling fragments.
