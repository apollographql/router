...
A router needs a schema for the graph that it's orchestrating. For this guide, we're downloading an example supergraph schema that we'll provide to the router.
