...
To enable observability, the router supports telemetry that can be added and customized in every stage of the router request lifecycle. You can add logs, metrics, and traces and export them to your application performance monitoring (APM) solution.
...
- Learn about [client observability](/graphos/routing/observability/client-id-enforcement/).
