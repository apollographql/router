...
You can either automatically download the router for your platform directly to your current directory, or manually download the router bundle for your platform.
...
With the router binary now in your current directory, go to the step [Running the binary](#running-the-binary).
