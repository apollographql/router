...
description: Configure the New Relic exporter for tracing via OpenTelemetry Protocol (OTLP) in the Apollo GraphOS Router.
---

Enable and configure the [OTLP exporter](./otlp) for tracing in the GraphOS Router for use with [New Relic](https://newrelic.com/).
