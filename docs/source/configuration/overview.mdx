...
The Apollo Router support [Cross Origin Resource Sharing](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS)
...
You can set it up in the configuration file's [telemetry section](../telemetry).
