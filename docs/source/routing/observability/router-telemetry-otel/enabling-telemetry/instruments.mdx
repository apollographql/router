...
The [`default_requirement_level` setting](#default_requirement_level) configures whether or not these instruments are enabled by default. Out of the box, its default value of `required` enables them, setting them to `true`. You must explicitly configure an instrument for different behavior. 
...
telemetry:
  instrumentation:
    instruments:
      router:
        http.server.active_requests: false # (default true)
        http.server.request.body.size: false # (default true)
        http.server.request.duration: false # (default true)
        http.server.response.body.size: false # (default true)
      subgraph:
        http.client.request.body.size: false # (default true)
        http.client.request.duration: false # (default true)
        http.client.response.body.size: false # (default true)
      connector:
        http.client.request.body.size: false # (default true)
        http.client.request.duration: false # (default true)
        http.client.response.body.size: false # (default true)
