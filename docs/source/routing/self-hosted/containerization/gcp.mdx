...
Before you begin, set up the tools you need to deploy the router on Cloud Run:
...
After setting up Docker and GCP, build a router image with custom router configuration and push the image to GCP:
