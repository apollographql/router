...
You define and use the directives on a subgraph level, and the router [composes](#composition-and-federation) them on to the supergraph schema.
...
Regardless of which you choose, you need to include **claims** in a request's context.
