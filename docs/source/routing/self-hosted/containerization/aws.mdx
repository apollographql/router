...
If your organization uses a corporate proxy with TLS inspection, the recommended approach is to [add the proxy's root certificate to the container](proxy-certificates).
...
1. Set up your [AWS environment](https://aws.amazon.com/getting-started/guides/setup-environment/)
    - Install the AWS CLI.
