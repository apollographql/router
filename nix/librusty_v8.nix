# Pre-fetches the librusty_v8 library used by the deno runtime.
#
# This needs to be kept up-to-date with the version of librusty_v8 specified in
# Cargo.toml.
#
# Note: This can be removed once deno is no more.
{pkgs}: let
  fetch_librusty_v8 = with pkgs;
    args:
      fetchurl {
