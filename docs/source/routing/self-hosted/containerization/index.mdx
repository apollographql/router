...
- [Proxy certificates](/graphos/routing/self-hosted/containerization/proxy-certificates): The recommended approach for TLS inspection environments is to add the proxy's root certificate.
