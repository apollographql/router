...
- `SupergraphRequest`: The `SubgraphService` is about process a graphql request.
- `SupergraphResponse`: The `SubgraphService` has just send a subgraph response.
