...
- For connector stages, `body` is a JSON _string_ for requests and a JSON _object_ for responses.
  - The request body is the raw HTTP body string that will be sent to the REST API.
