...
impl InstrumentData {
    ...
    pub(crate) fn populate_config_instruments(&mut self, yaml: &serde_json::Value) {
        ...
        populate_config_instrument!(
            ...
            opt.traces.otlp.exporter.scheduled_delay,
            "$.traces.otlp.exporter.scheduled_delay",
            opt.traces.otlp.exporter.max_concurrent_exports,
            "$.traces.otlp.exporter.max_concurrent_exports",
            opt.traces.otlp.exporter.max_export_batch_size,
            "$.traces.otlp.exporter.max_export_batch_size",
            opt.traces.otlp.exporter.max_export_timeout,
            "$.traces.otlp.exporter.max_export_timeout",
            opt.traces.otlp.exporter.max_queue_size,
            "$.traces.otlp.exporter.max_queue_size",
            opt.traces.usage_reports.exporter.scheduled_delay,
            "$.traces.usage_reports.exporter.scheduled_delay",
            opt.traces.usage_reports.exporter.max_concurrent_exports,
            "$.traces.usage_reports.exporter.max_concurrent_exports",
            opt.traces.usage_reports.exporter.max_export_timeout,
            "$.traces.usage_reports.exporter.max_export_timeout",
            opt.metrics.otlp.exporter.scheduled_delay,
            "$.metrics.otlp.exporter.scheduled_delay",
            opt.metrics.otlp.exporter.max_export_timeout,
            "$.metrics.otlp.exporter.max_export_timeout",
            opt.metrics.usage_reports.exporter.scheduled_delay,
            "$.metrics.usage_reports.exporter.scheduled_delay",
            opt.metrics.usage_reports.exporter.max_concurrent_exports,
            "$.metrics.usage_reports.exporter.max_concurrent_exports",
            opt.metrics.usage_reports.exporter.max_export_timeout,
            "$.metrics.usage_reports.exporter.max_export_timeout"
        );
