...
pub(crate) struct QueryPlanningParameters<'a> {
    ...
    /// Lookups of GraphQL Federation source schemas (entity fetches into them call lookups).
    pub(crate) lookup_index: Arc<crate::composite_schemas::lookup_index::LookupIndex>,
...
impl<'a: 'b, 'b> QueryPlanningTraversal<'a, 'b> {
    ...
    fn resolve_condition_plan(
        ...
        let parameters = QueryPlanningParameters {
            ...
            lookup_index: self.parameters.lookup_index.clone(),
