...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.10.2
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.10.2 --values my-values.yaml
```
