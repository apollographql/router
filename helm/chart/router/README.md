...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.27.0-alpha.1
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.27.0-alpha.1 --values my-values.yaml
```
