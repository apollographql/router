...
async fn integration_test_basic() -> Result<(), BoxError> {
    ...
    let cache_key = "version:1.0:subgraph:products:type:Query:hash:2253c22516befea8a5eb2b997cd875b0b2c67023b1917accc1495d8f318914ed:data:070af9367f9025bd796a1b7e0cd1335246f658aa4857c3a4d6284673b7d07fa6";
    check_cache_key!(&namespace, cache_key, &client);

    let cache_key = "version:1.0:subgraph:reviews:type:Product:representation:052fa800fa760b2ac78669a5b0b90f512158eddab8d01eabb4e65b286ff09ecd:hash:6c7a8d96b2abd576c72c25f4db7094c35f388034a3dbad7e7aed5f82a9f23053:data:070af9367f9025bd796a1b7e0cd1335246f658aa4857c3a4d6284673b7d07fa6";
    check_cache_key!(&namespace, cache_key, &client);
