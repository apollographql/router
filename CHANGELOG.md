...
The [Native customizations section of the docs](https://www.apollographql.com/docs/router/customizations/native/) was wrongly portraying Plugin services taking `&mut self` while they take `&self`.
