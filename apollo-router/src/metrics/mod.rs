        ...
        paste::paste! {
            {
                ...
                if cache_callsite {
                    static INSTRUMENT_CACHE: std::sync::OnceLock<crate::sync::Mutex<std::sync::Weak<opentelemetry::metrics::[<$instrument:camel>]<$ty>>>> = std::sync::OnceLock::new();
                    ...
                    let mut instrument_guard = INSTRUMENT_CACHE
                        .get_or_init(|| {
                            ...
                            crate::sync::Mutex::new(std::sync::Arc::downgrade(&instrument_ref))
                        })
                        .lock();
