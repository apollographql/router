...
Make sure to [enable prometheus metrics](../configuration/metrics/#using-prometheus) in your configuration if you want to have metrics generated by the Router.
