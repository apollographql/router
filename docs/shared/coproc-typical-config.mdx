...
coprocessor:
  ...
  timeout: 2s # The timeout for all coprocessor requests. Defaults to 1 second (1s). Supported duration formats: https://docs.rs/humantime/latest/humantime/fn.parse_duration.html
