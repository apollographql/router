...
Be aware that they can override or interfere with your router's built-in telemetry configuration.

**In Apollo Router versions earlier than v2.13.0**, these variables take precedence over your router's telemetry settings and may cause traces or metrics to be sent to an unintended destination.

**Starting in Apollo Router v2.13.0 and later, your router will _refuse to start_ if any of these variables are set.**
Remove them from your environment before launching Router.
