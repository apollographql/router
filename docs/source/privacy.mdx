...
description: Learn what data the Apollo GraphOS Router collects and how to opt out. By default, the router collects anonymous usage data to help improve the product.
---
