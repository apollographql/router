...
description: Configure logging output to stdout in the Apollo GraphOS Router. Format in human-readable text or machine-readable JSON.
---

You can configure GraphOS Router logging to be directed to stdout, and its output format can be set to text or JSON.
