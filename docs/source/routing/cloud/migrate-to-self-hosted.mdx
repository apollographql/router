...
After you migrate all graphs to self-hosted mode, navigate to the Billing and Usage page to move your organization to a supported plan. See the [Plan Selection Troubleshooting page](https://support.apollographql.com/space/ETKB/2006712337/Plan+Selection+Troubleshooting) for more information.
