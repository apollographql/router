...
```
   Compiling router-bridge (https://github.com/apollographql/federation.git)
   Compiling apollo-router-core (router/crates/apollo-router-core)
   Compiling apollo-router (router/crates/apollo-router)
