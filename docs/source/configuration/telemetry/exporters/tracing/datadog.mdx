...
description: Configure the Datadog exporter for tracing via OpenTelemetry Protocol (OTLP) in the Apollo GraphOS Router.
---
...
Enable and configure the [Datadog](https://www.datadoghq.com/) exporter for tracing in the GraphOS Router.
