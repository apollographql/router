...
If your router requires requests to [a device or service on a private network](https://wicg.github.io/private-network-access/), you need to enable this behavior in your CORS configuration. Without this change, the browser won't allow any requests to be sent to a device on the private network.
