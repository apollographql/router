...
impl Subgraph<Upgraded> {
    ...
    /// Apply federation 3 compatibility transformations to the subgraph schema,
    /// returning any composition hints generated by the transformations.
    pub fn apply_fed3_compat(&mut self) -> Vec<CompositionHint> {
        crate::composition::fed3_compat::apply_fed3_compat(
