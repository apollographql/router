...
pub(crate) struct MetricsBuilder {
    ...
    pub(crate) apollo_realtime_meter_provider_builder: opentelemetry_sdk::metrics::MeterProviderBuilder,
...
impl MetricsBuilder {
    pub(crate) fn new(config: &Conf) -> Self {
        ...
        Self {
            ...
            apollo_realtime_meter_provider_builder: opentelemetry_sdk::metrics::SdkMeterProvider::builder(),
