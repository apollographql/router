...
If _every_ requested field requires authentication and a request is unauthenticated, Router returns `data: null` and reports errors according to the `errors` configuration below.
