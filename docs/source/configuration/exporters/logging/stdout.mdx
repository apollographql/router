...
subtitle: Configure logging to stdout including output format
description: Configure logging in the Apollo Router including log level and output format.
---

Logging in the Apollo Router can be directed to stdout.
For general loggin configuration, refer to [Router Logging Configuration](./overview).
