...
When writing plugins, you can access [GraphOS Studio operation IDs](/graphos/platform/insights/operation-signatures) by reading the value of `apollo_operation_id` from [`context`](#5-define-necessary-context).
