...
You can also have [conditions](./conditions) on your attributes, so instead of creating different custom metrics you could just put conditions on attributes you want to add in some cases:
        ...
        http.server.request.body.size:
          attributes:
            ...
            graphql.operation.name:
              ...
              condition: # Add this attribute only if the request header "debug" has the value "enabled"
                eq:
                - request_header: debug
                - "enabled"
        # Custom metric 
        acme.metric: 
          value: duration
