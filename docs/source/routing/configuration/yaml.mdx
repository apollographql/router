...
If your implementation requires the use of unknown fields on a defined type, you can opt out of stricter validation by specifying `strict_variable_validation: warn`.
