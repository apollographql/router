...
That's it! Visit `http://127.0.0.1:4000` to open the [Apollo Sandbox Explorer](/studio/explorer/sandbox/). You can inspect the entire federated graph and run your first queries against Apollo Router!

## Next steps

Now that you know how to run Apollo Router with a supergraph schema, you can:

* Setup [Apollo Managed Federation](./managed-federation/overview)
