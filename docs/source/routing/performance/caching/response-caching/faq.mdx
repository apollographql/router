...
The `preview_entity_cache` plugin has been removed in Router 3.0. If you're upgrading from Router 2.x, you must migrate to `response_cache` before upgrading. The new implementation provides better performance and more flexible caching controls.
