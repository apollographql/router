...
subtitle: Run an Apollo Runtime container image in Docker with examples covering basic setup and configuration overrides.
...
To serve MCP requests, enable the [MCP server](https://www.apollographql.com/docs/apollo-mcp-server) and publish por `5000`. 
