...
The option to redirect to [Apollo Explorer](https://www.apollographql.com/docs/studio/explorer/) has existed since [Router v1.13.1](https://github.com/apollographql/router/releases/tag/v1.13.1).  
To enable this, explicitly set the `graph_ref` under the `homepage` configuration:
