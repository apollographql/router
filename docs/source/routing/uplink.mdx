...
For blue-green deployment strategies using OCI artifacts, see [Deployment Strategies](/graphos/routing/configuration/deployment-strategies#blue-green-deployment).
