...
GraphOS supports [self-hosted and cloud graphs](/graphos/routing/about-router#graphos-router-deployment-types), each recommended for different use cases. You may want to migrate to a cloud graph in these scenarios:
