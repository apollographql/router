...
You can include include request bodies, including the GraphQL operations, in your telemetry by instrumenting [`events` in the supergraph service](/graphos/reference/router/telemetry/instrumentation/events) like so:
