...
description: Enable and configure the Datadog exporter for tracing via OpenTelemetry in the Apollo Router
---
...
To configure the router, enable the [OTLP exporter](./opentelemetry) and set `endpoint: <datadog-agent-endpoint>`. For example: 
