---
title: Zipkin exporter (via OTLP)
description: Enable and configure the Zipkin exporter for tracing via OpenTelemetry in the Apollo Router
---
...
### `endpoint`
The Zipkin endpoint. Defaults to http://127.0.0.1:9411/api/v2/span
