...
The URL that this coprocessor request pertains to.

At the `RouterService` stage, this is the path the resquest was made to.
At the `SubgraphService` request stage, this is the full URL the subgraph request will be made to.
