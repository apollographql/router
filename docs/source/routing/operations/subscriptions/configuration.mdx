...
1. Make sure your router is [connected to GraphOS](/graphos/routing/graphos-features/#enabling-licensed-plan-features) with a graph API key and graph ref.
    - Subscription support is a [licensed feature](/graphos/routing/graphos-features) available on all GraphOS plans (Free, Developer, Standard, Enterprise).
