...
limits:
  ...
  connector:
    ...
    sources:
      products.rest:
        http_max_response_size: 10mb # per-source override (10 MB)
```
...
The default value is `10000000` (10 million). This limit is available on all plans and does not require a license. Set to `null` to disable.
