...
> If a tarball for your system or architecture isn't available, you can [build and run the Apollo Router from source](./quickstart/build/).
...
```bash
curl -L https://supergraph.demo.starstuff.dev/ > supergraph-schema.graphql
```
...
* Learn about [advanced configuration options](./settings/configuration/)
