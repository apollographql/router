...
## Configure CSRF prevention in the router
...
**We highly recommend that you leave CSRF prevention enabled**. 

However, it is still possible to disable the plugin entirely:
