...
fn extracts_demand_control_directives() {
    let subgraphs = Supergraph::new(r#"
      schema
          ...
          @link(url: "https://specs.apollo.dev/listSize/v0.1")
        {
          query: Query
        }
...
fn extracts_renamed_demand_control_directives() {
    let subgraphs = Supergraph::new(r#"
      ...
      @link(url: "https://specs.apollo.dev/link/v1.0")
      @link(url: "https://specs.apollo.dev/join/v0.5", for: EXECUTION)
      @link(url: "https://specs.apollo.dev/cost/v0.1", as: "renamedCost")
      @link(url: "https://specs.apollo.dev/listSize/v0.1", as: "renamedListSize")
    {
      query: Query
    }
