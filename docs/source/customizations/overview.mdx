...
description: Extend the GraphOS Router or GraphOS Router Core with custom functionality. Understand the request lifecycle and how customizations intervene at specific points.
---
...
The Apollo Router Core supports [Rhai scripts](./rhai/).
