...
> **Note:** These environment variables are *not* currently recognised by spaceport. This is being tracked by [issue #425](https://github.com/apollographql/router/issues/425).  Please follow and enage on that issue if you're interested in this functionality!
