...
The router also accepts a `RUST_LOG` environment variable with the same possible values as the command-line argument. If you provide _both_, the command-line argument takes precedence.
