...
description: Configure the Prometheus metrics exporter endpoint in the Apollo GraphOS Router.
---

Enable and configure the [Prometheus](https://www.prometheus.io/) exporter for metrics in the GraphOS Router.
