...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.20.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.20.0 --values my-values.yaml
```
