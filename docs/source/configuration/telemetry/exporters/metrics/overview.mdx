...
subtitle: Export GraphOS Router metrics
description: Collect and export metrics from the Apollo GraphOS Router for Prometheus, OpenTelemetry Protocol (OTLP), Datadog, and New Relic.
---

The GraphOS Router supports collection of metrics with [OpenTelemetry](https://opentelemetry.io/), with exporters for:
...
Use [resource attributes](#resource) instead to provide information about telemetry resources, including hosts and environments.
