...
Note: This example is generated using the helm template capability to generate the required kubernetes configuration from our helm chart.
...
metadata:
  name: router-test
  labels:
    helm.sh/chart: router-0.1.1
    app.kubernetes.io/name: router
    app.kubernetes.io/instance: router-test
    app.kubernetes.io/version: "v0.1.0-preview.7"
...
kind: Pod
metadata:
  name: "router-test-test-connection"
  labels:
    helm.sh/chart: router-0.1.1
    app.kubernetes.io/name: router
    app.kubernetes.io/instance: router-test
