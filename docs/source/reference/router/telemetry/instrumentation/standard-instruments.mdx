...
- `apollo_router_session_count_active` - **Deprecated**: Number of in-flight GraphQL requests
- `apollo_router_http_requests_total` - **Deprecated**: Total number of HTTP requests by HTTP status
- `apollo_router_http_request_duration_seconds_bucket` - **Deprecated**: HTTP router request duration
- `apollo_router_http_request_duration_seconds_bucket` - **Deprecated**: HTTP subgraph request duration, attributes:
