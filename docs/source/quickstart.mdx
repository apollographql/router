...
That's it! Visit `http://127.0.0.1:4000` to open the [Apollo Sandbox Explorer](/studio/explorer/). You can inspect the entire federated graph and run your first queries against Apollo Router!
