---
title: Subgraph Authentication in the GraphOS Router
subtitle: Implement subgraph authentication using AWS SigV4 
description: Secure communication to AWS subgraphs via the GraphOS Router using AWS Signature Version 4 (SigV4). 
minVersion: 1.27.0
---

The GraphOS Router supports subgraph request authentication and key rotation via [AWS Signature Version 4](https://docs.aws.amazon.com/AmazonS3/latest/API/sig-v4-authenticating-requests.html) (SigV4).

This allows you to secure communication to AWS subgraphs by making sure a subgraph request was made by the GraphOS Router, and the payload hasn't been tampered with.
