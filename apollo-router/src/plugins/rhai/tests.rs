...
async fn it_can_process_execution_request() {
    macros::gen_request_test!(ExecutionRequest, "process_execution_request");
}

#[tokio::test]
async fn it_can_process_subgraph_request() {
    macros::gen_request_test!(SubgraphRequest, "process_subgraph_request");
}

#[tokio::test]
async fn it_can_process_supergraph_response() {
    macros::gen_response_test!(RhaiSupergraphResponse, "process_supergraph_response");
}

#[tokio::test]
async fn it_can_process_supergraph_deferred_response() {
    macros::gen_response_test!(
...
async fn it_can_process_execution_response() {
    macros::gen_response_test!(RhaiExecutionResponse, "process_execution_response");
}

#[tokio::test]
async fn it_can_process_execution_deferred_response() {
    macros::gen_response_test!(RhaiExecutionDeferredResponse, "process_execution_response");
}
