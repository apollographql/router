...
You can conditionally include include request bodies, including GraphQL operations, in your telemetry by applying conditions to a router request [event](/graphos/reference/router/telemetry/instrumentation/events) like so:
