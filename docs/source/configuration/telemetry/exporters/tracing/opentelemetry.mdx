---
title: Export traces to OpenTelemetry Protocol (OTLP)
description: Enable and configure the OTLP exporter for tracing via OpenTelemetry in the Apollo Router
---
...
Enable and configure the [OTLP](https://www.opentelemetry.io/) exporter for tracing in the Apollo Router.

[OTLP (OpenTelemetry Protocol)](https://github.com/open-telemetry/opentelemetry-proto/blob/main/docs/specification.md) is the native protocol for OpenTelemetry. It can be used to export traces over HTTP or gRPC to a variety of backends including:
