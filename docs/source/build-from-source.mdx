...
That's it! Visit `localhost:4000` to open the [Apollo Explorer Sandbox](/studio/explorer/). You can inspect the entire example federated graph and run your first queries against the Apollo Router.
