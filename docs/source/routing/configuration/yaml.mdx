...
import Events from '../../../shared/config/events.mdx';
...
Learn more in [Event stream-backed subscriptions](/graphos/routing/operations/subscriptions/event-streams/overview).
