...
To learn more, go to [Router Telemetry](/graphos/routing/observability/router-telemetry-overview).
...
- Learn how to [configure router telemetry](/graphos/routing/observability/router-telemetry-overview)
