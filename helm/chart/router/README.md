...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.16.3
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.16.3 --values my-values.yaml
```
