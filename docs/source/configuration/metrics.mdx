...
- `apollo_router_query_planning_time` - Time spent planning queries in seconds (both for plan and warmup `phase`).
- `apollo_router_schema_loading_time` - Time spent loading the schema.
