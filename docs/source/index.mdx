...
**The Apollo Router** is a configurable, high-performance router for your federated GraphQL API (also known as a [supergraph](/graphos/graphs/overview/#self-hosted-supergraphs)):
...
> **This documentation helps you run a _self-hosted_ instance of the Apollo Router.** If you [create a cloud supergraph](/studio/getting-started/) with Apollo GraphOS, Apollo provisions and hosts your router for you.
>
