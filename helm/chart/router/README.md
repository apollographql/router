...
![Version: 1.57.1-rc.0](https://img.shields.io/badge/Version-1.57.1--rc.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.57.1-rc.0](https://img.shields.io/badge/AppVersion-v1.57.1--rc.0-informational?style=flat-square)
...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.57.1-rc.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.57.1-rc.0 --values my-values.yaml
```
