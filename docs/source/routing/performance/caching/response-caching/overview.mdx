...
For globally distributed deployments with multiple regions, see the [Multi-Region Edge Cache Architecture](/graphos/routing/performance/caching/edge-cache-architecture) guide.
