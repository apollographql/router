...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.17.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.17.0 --values my-values.yaml
```
...
| dnsConfig | object | `{}` | A map of dnsConfig options, Example: dnsConfig:   options:     - name: "ndots"       value: "2" |
