...
Histogram metrics cap values at the highest bucket boundary. With the default buckets, any request taking longer than ten seconds appears in the `10.0+` bucket. This makes timeouts appear unrespected in your metrics if you configure timeouts greater than ten seconds.
...
When customizing buckets, set your highest bucket value greater than or equal to your configured timeout values. This accurately represents timeout behavior in your metrics.
