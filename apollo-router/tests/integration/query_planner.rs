...
async fn fed2_schema_with_new_qp() {
    ...
    router
        .assert_metrics_contains(
            &format!(r#"apollo_router_lifecycle_query_planner_init_total{{init_is_success="true",otel_scope_name="apollo/router",process_executable_name="router",service_name="unknown_service:router",service_version="{}"}} 1"#, std::env!("CARGO_PKG_VERSION")),
            None,
        )
        .await;
