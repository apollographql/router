...
Set your router timeout to be greater than your subgraph timeouts. This enables the router to properly handle subgraph timeouts and return appropriate error responses to clients. Configure subgraph timeouts to be lower than the router timeout to provide processing buffer time.
