...
traffic_shaping:
  ...
  subgraphs: # Rules applied to requests from the router to individual subgraphs
    products:
      ...
      dns_resolution_strategy: ipv4_then_ipv6 # Changes DNS resolution strategy for subgraph.
```
...
You can also change DNS resolution strategy applied to subgraphs's URL:
```yaml title="router.yaml"
traffic_shaping:
  all:
    dns_resolution_strategy: ipv4_then_ipv6
