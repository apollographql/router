...
Limits how many errors a connector's response mapping may add to the GraphQL `errors` array using the [`->withError` method](/graphos/connectors/responses/error-handling#report-errors-without-failing-a-field).
