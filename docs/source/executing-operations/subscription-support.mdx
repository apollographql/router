...
> ⚠️ **Important:** To use subscriptions with the Apollo Router, you must first complete certain [prerequisites](#prerequisites).
...
1. A client executes a GraphQL subscription operation against your router _over HTTP:_
