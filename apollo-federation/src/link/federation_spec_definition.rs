...
impl FederationSpecDefinition {
    ...
    fn override_directive_specification(&self) -> DirectiveSpecification {
        ...
        if *self.version() >= (Version { major: 2, minor: 7 }) {
...
impl SpecDefinition for FederationSpecDefinition {
    ...
    fn directive_specs(&self) -> Vec<Box<dyn TypeAndDirectiveSpecification>> {
        ...
        if *self.version() >= (Version { major: 2, minor: 1 }) {
        ...
        if *self.version() >= (Version { major: 2, minor: 5 }) {
        ...
        if *self.version() >= (Version { major: 2, minor: 9 })
