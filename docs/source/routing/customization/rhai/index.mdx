...
- Eliminates `RwLock` contention on the string interner under concurrent load, which can meaningfully improve throughput for deployments processing many concurrent requests through Rhai scripts
