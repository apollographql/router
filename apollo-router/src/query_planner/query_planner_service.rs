...
mod tests {
    ...
    async fn federation_versions() {
        async {
            ...
            assert_eq!(error.to_string(), "supergraphs composed with federation version 1 are not supported, and need to be recomposed with federation version 2 or greater");
