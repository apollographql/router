...
When writing plugins, you can get access [GraphOS Studio operation IDs](/graphos/platform/insights/operation-signatures) by reading the value of `apollo::supergraph::operation_id` from [`context`](#5-define-necessary-context).
