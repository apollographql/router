...
impl ConnectorCacheConfiguration {
    ...
    fn is_source_enabled(&self, source_name: &str) -> bool {
...
fn hash_private_id(context: &Context, key_name: &str) -> Option<String> {
...
struct ConnectorCacheService {
    service: tower::util::BoxCloneService<connect::Request, connect::Response, BoxError>,
    storage: Arc<StorageInterface>,
    connectors_config: Arc<ConnectorCacheConfiguration>,
    private_queries: Arc<RwLock<LruCache<PrivateQueryKey, ()>>>,
    debug: bool,
    supergraph_schema: Arc<Valid<Schema>>,
    subgraph_enums: Arc<HashMap<String, String>>,
...
type ConnectorRequestBoxCloneService = tower::util::BoxCloneService<
...
#[derive(Clone)]
struct ConnectorRequestCacheService {
    service: ConnectorRequestBoxCloneService,
    storage: Arc<StorageInterface>,
    source_name: String,
    connector_ttl: Duration,
    private_id_key: Option<String>,
    debug: bool,
    supergraph_schema: Arc<Valid<Schema>>,
    subgraph_enums: Arc<HashMap<String, String>>,
    private_queries: Arc<RwLock<LruCache<PrivateQueryKey, ()>>>,
