...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.34.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.34.0 --values my-values.yaml
```
