...
preview_response_cache:
  enabled: true
  debug: true # Enable the ability to return debugging data for caching debugger. Avoid enabling this in production.
  invalidation:
    listen: 0.0.0.0:4000
    path: /invalidation
  subgraph:
    ...
    subgraphs:
      ...
      products:
        shared_key: ${env.INVALIDATION_SHARED_KEY_PRODUCTS} # Use different key for products
        redis:
