...
pub(crate) const fn default_required_to_start() -> bool {
    false
}

pub(crate) const fn default_pool_size() -> u32 {
    5
}
...
pub(crate) const fn default_idle_timeout() -> Duration {
    Duration::from_secs(60)
}

pub(crate) const fn default_acquire_timeout() -> Duration {
    Duration::from_millis(50)
}

pub(crate) const fn default_batch_size() -> usize {
    100
}
...
pub(crate) struct PostgresCacheStorage {
    ...
    pub(crate) cleanup_interval: TimeDelta,
}
