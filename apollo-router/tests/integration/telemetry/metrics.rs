...
async fn test_graphql_metrics() {
    ...
    router.execute_default_query().await;
    router
        .assert_metrics_contains(r#"graphql_field_list_length_sum{graphql_field_name="topProducts",graphql_field_type="Product",graphql_type_name="Product",otel_scope_name="apollo/router"} 3"#, None)
        .await;
    router
        .assert_metrics_contains(r#"graphql_field_list_length_bucket{graphql_field_name="topProducts",graphql_field_type="Product",graphql_type_name="Product",otel_scope_name="apollo/router",le="5"} 1"#, None)
        .await;
    router
        .assert_metrics_contains(r#"graphql_field_execution_total{graphql_field_name="name",graphql_field_type="String",graphql_type_name="String",otel_scope_name="apollo/router"} 3"#, None)
        .await;
    router
        .assert_metrics_contains(r#"graphql_field_execution_total{graphql_field_name="topProducts",graphql_field_type="Product",graphql_type_name="Product",otel_scope_name="apollo/router"} 4"#, None)
        .await;
    router
        .assert_metrics_contains(r#"custom_counter_total{graphql_field_name="name",graphql_field_type="String",graphql_type_name="String",otel_scope_name="apollo/router"} 3"#, None)
        .await;
    router
        .assert_metrics_contains(r#"custom_histogram_sum{graphql_field_name="topProducts",graphql_field_type="Product",graphql_type_name="Product",otel_scope_name="apollo/router"} 3"#, None)
        .await;
}
