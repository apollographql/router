...
![Version: 1.41.0-rc.1](https://img.shields.io/badge/Version-1.41.0--rc.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.41.0-rc.1](https://img.shields.io/badge/AppVersion-v1.41.0--rc.1-informational?style=flat-square)
...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.41.0-rc.1
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.41.0-rc.1 --values my-values.yaml
```
