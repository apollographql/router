### feat: query planner dry-run option ([PR #6635](https://github.com/apollographql/router/pull/6635))
...
By [@aaronArinder](https://github.com/aaronArinder) and [@lennyburdette](https://github.com/lennyburdette) in https://github.com/apollographql/router/pull/6635.
