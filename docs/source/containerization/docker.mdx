---
title: Run in Docker
description: Run the Apollo Router in Docker
---

import { Link } from "gatsby";
import ElasticNotice from '../../shared/elastic-notice.mdx';

Follow examples in this guide to learn how to run an Apollo Router container image in Docker:
...
Here's a basic example of running a router image in Docker (make sure to replace `<image version>` with whichever version you want to use, such as `v1.4.0`):
