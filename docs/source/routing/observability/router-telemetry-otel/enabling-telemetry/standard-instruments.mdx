...
- `apollo.router.limits.subgraph_response_size.exceeded` - A counter of subgraph responses aborted because their body exceeded the configured [`http_max_response_bytes`](/router/security/request-limits#http_max_response_bytes) limit.
