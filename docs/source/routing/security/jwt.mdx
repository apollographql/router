...
If your router [exports metrics](/router/configuration/telemetry/exporters/metrics/overview), the JWT authentication plugin provides and exports the following metrics:
