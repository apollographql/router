...
By default, when a query is filtered by authorization (either partially or entirely), the list of filtered paths is added to the response and logged by the router. This behavior can be customized for your needs.
