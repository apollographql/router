...
For blue-green deployment strategies using OCI artifacts, see [Deployment Best Practices](/graphos/platform/production-readiness/deployment-best-practices#blue-green-with-graph-artifacts).
