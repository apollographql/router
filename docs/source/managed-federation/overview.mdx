...
With managed federation, your subgraphs each publish their schemas to the Apollo registry, which verifies that they successfully [compose](/federation/v2/federated-types/composition/) into a federated schema.
