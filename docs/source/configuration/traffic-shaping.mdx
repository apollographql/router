...
- **APQ**: - Whether to use Automatic Persisted Queries (APQ) in subgraph calls.
...
The Apollo Router supports various options affecting traffic destined for subgraphs, that can either be defined for all subgraphs,
