...
Your Rhai scripts can hook into any combination of the above services (if you are using v1.30.0+). They can modify the request, response, and/or related metadata as they're passed along.
