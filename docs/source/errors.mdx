...
You can create Rhai scripts that throw custom status codes. See [Terminating client requests](/router/customizations/rhai-api#terminating-client-requests) to learn more.
