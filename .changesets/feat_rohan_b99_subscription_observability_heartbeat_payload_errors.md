...
- **`apollo.router.operations.subscriptions.ended.subgraph`** (attributes: `subgraph.service.name`): The subgraph closed the WebSocket connection, ending the subscription stream for all deduplicated clients.
