...
Cloud routers running with the [Free plan](https://www.apollographql.com/pricing) are rate limited to 60 requests per minute. 

For requests in excess of this limit, the router returns an HTTP 429 (Too Many Requests) response.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        router. Connecting your self-hosted router to GraphOS requires an{" "}
...
GraphOS features with a [free
trial](https://studio.apollographql.com/signup?referrer=docs-content).
