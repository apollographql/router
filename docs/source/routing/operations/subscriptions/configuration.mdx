...
By default, subscriptions can remain open indefinitely. Set a maximum duration using `max_lifetime` to have the router close the subscription and send a terminal error to the client after the configured duration:
