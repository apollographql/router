...
description: Configure the New Relic exporter for metrics via OpenTelemetry Protocol (OTLP) in the Apollo GraphOS Router.
---

Enable and configure the [OTLP exporter](./otlp) for metrics in the Apollo GraphOS Router for use with [New Relic](https://newrelic.com/).
