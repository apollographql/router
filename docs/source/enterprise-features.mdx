...
1. Provide the offline license to your router on startup. The router accepts an offline license in a few ways:
    ...
    1. [`--license <license_path>`](./configuration/overview/#--license) CLI option
    1. [`APOLLO_ROUTER_LICENSE_PATH`](./configuration/overview/#--license) environment variable
    1. [`APOLLO_ROUTER_LICENSE`](./configuration/overview/#--license) environment variable
...
1. Configure the router to use a local supergraph schema by setting one of the following:
    ...
    * [`--s/-supergraph`](./configuration/overview/#-s----supergraph) CLI option
    * [`APOLLO_SUPERGRAPH_PATH`](./configuration/overview/#-s----supergraph) environment variable
    * [`APOLLO_SUPERGRAPH_URLS`](./configuration/overview/#-s----supergraph) environment variable
