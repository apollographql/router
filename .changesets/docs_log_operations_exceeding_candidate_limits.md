### Document how to log operations that exceed a candidate operation limit
...
By [@smyrick](https://github.com/smyrick) in https://github.com/apollographql/router/pull/PULL_NUMBER
