...
The template now uses `kindIs "invalid"` to correctly detect whether a value was explicitly set, and an `else if` to prevent both fields from being rendered simultaneously — which Kubernetes rejects.
