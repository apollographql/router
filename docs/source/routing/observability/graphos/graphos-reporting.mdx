...
Whatever these samplers let through is then subject to a safeguard that further reduces GraphOS trace volume — see [Apollo trace throttling](#apollo-trace-throttling).
