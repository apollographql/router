...
![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.1.0-preview.2](https://img.shields.io/badge/AppVersion-v0.1.0--preview.2-informational?style=flat-square)
...
| ingress.tls | list | `[]` |  |
| managedFederation.apiKey | string | `""` | If using managed federation, the graph API key to identify router to Studio |
