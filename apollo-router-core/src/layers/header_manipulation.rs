...
impl HeaderManipulationLayer {
    pub fn propagate_all() -> HeaderManipulationLayer {
        Self {
            operation: PropagateAll,
        }
    }

    pub fn propagate(header_name: HeaderName) -> HeaderManipulationLayer {
        Self {
            operation: Propagate(header_name),
        }
    }

    pub fn propagate_or_default(
    ...
    pub fn insert(header_name: HeaderName, header_value: HeaderValue) -> HeaderManipulationLayer {
        Self {
            operation: Insert(header_name, header_value),
        }
    }

    pub fn remove(header_name: HeaderName) -> HeaderManipulationLayer {
        Self {
