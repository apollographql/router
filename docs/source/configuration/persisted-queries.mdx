...
***For more information on how to register queries, configure your router and update your graphql clients see the main [Persisted Query documentation](https://www.apollographql.com/docs/graphos/operations/persisted-queries).***
...
Enabling safelisting requires creation of a Persisted Query List (PQL). Refer to the [Persisted Query documentation](https://www.apollographql.com/docs/graphos/operations/persisted-queries) for more information on how to create these and update your clients. 
