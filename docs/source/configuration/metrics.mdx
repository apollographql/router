...
If you need to add attributes/labels on your generated metrics, for example add a custom attributes/labels coming from a specific header in the original HTTP request, or insert custom attributes/labels on every metrics.
