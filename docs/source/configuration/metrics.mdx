...
If you need to add labels on your generated metrics, for example add a custom labels coming from a specific header in the original HTTP request, or insert custom labels on every metrics.
