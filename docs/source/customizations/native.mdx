...
## Using macros
To create custom metrics, traces, and spans you can use the [tracing macros](https://docs.rs/tracing/latest/tracing/index.html#macros) to generate events and logs.
...
To create your custom metrics in [Prometheus](https://prometheus.io/) you can use the [event macros](https://docs.rs/tracing/latest/tracing/index.html#macros) to generate an event.
...
Make sure to [enable OpenTelemtry tracing](../configuration/telemetry/exporters/tracing/overview) in your configuration if you want to custom traces generated and linked by the Router.

</Note>

To create custom spans and traces you can use the [tracing macros](https://docs.rs/tracing/latest/tracing/index.html#macros) to generate a span.
