---
title: Metrics common configuration
---
...
Open telemetry includes many [standard attributes](https://opentelemetry.io/docs/specs/semconv/attributes-registry/). You can use these via custom [instruments](../instruments.mdx). 
