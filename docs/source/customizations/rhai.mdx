...
* Place all of your Rhai files in a specific directory.
...
You can modify any of these defaults in your [YAML config file](../configuration/overview/#yaml-config-file) like so:
