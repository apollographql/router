...
Because GraphOS Router supports a collection of features specific to GraphOS, self-hosting GraphOS Router requires a current GraphOS [Enterprise or Free plan](https://www.apollographql.com/pricing). Learn more about [GraphOS Router features](/graphos/routing/graphos-features).
