...
subtitle: Migrating to the GraphOS Router from @apollo/gateway
description: Learn how to migrate a federated graph from @apollo/gateway to the Apollo GraphOS Router without any changes to your subgraphs.
---

Learn how to migrate a federated supergraph using the `@apollo/gateway` library to the GraphOS Router and gain significant performance improvements while making zero changes to your subgraphs.
...
For more information, see [Logging in the GraphOS Router](./configuration/logging/).
