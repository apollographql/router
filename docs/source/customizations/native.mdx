...
This is the most heart of implementing your plugin and this can be as simple or as complex as is required to satisfy your requirements. The details of what you'll actually do here are going to vary widely, but the structure of your plugin is going to be fairly consistent. I recommend you follow this template:
