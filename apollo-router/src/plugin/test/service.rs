    ...
    ($name:ident, $request_type:tt < $req_generic:tt > , $response_type:tt < $res_generic:tt >) => {
        paste::item! {
            mockall::mock! {
                ...
                #[allow(dead_code)]
                pub [<$name Service>] {
                    pub fn call(&mut self, req: $request_type<$req_generic>) -> Result<$response_type<$res_generic>, tower::BoxError>;
                }
...
mock_service!(HttpClient, HyperRequest<Body>, HyperResponse<Body>);
