    ...
    helper::FileUploadTestServer::builder()
        ...
        .run_test(|response| {
            insta::assert_json_snapshot!(response, @r###"
            {
              "errors": [
                {
                  "message": "HTTP fetch failed from 'uploads': HTTP fetch failed from 'uploads': error from user's HttpBody stream: error reading a body from connection: error reading a body from connection: Missing files in the request: '0'.",
                  "path": [],
                  "extensions": {
                    "code": "SUBREQUEST_HTTP_ERROR",
                    "service": "uploads",
                    "reason": "HTTP fetch failed from 'uploads': error from user's HttpBody stream: error reading a body from connection: error reading a body from connection: Missing files in the request: '0'."
                  }
                }
              ]
            }
    ...
    helper::FileUploadTestServer::builder()
        ...
        .run_test(|response| {
            insta::assert_json_snapshot!(response, @r###"
            {
              "errors": [
                {
                  "message": "HTTP fetch failed from 'uploads': HTTP fetch failed from 'uploads': error from user's HttpBody stream: error reading a body from connection: error reading a body from connection: Exceeded the limit of 512.0 KB on 'fat.payload.bin' file.",
                  "path": [],
                  "extensions": {
                    "code": "SUBREQUEST_HTTP_ERROR",
                    "service": "uploads",
                    "reason": "HTTP fetch failed from 'uploads': error from user's HttpBody stream: error reading a body from connection: error reading a body from connection: Exceeded the limit of 512.0 KB on 'fat.payload.bin' file."
                  }
                }
              ]
            }
    ...
    helper::FileUploadTestServer::builder()
        ...
        .run_test(|response| {
            insta::assert_json_snapshot!(response, @r###"
            {
              ...
              "errors": [
                {
                  "message": "HTTP fetch failed from 'uploads_clone': HTTP fetch failed from 'uploads_clone': error from user's HttpBody stream: error reading a body from connection: error reading a body from connection: Missing files in the request: '1'.",
                  "path": [],
                  "extensions": {
                    "code": "SUBREQUEST_HTTP_ERROR",
                    "service": "uploads_clone",
                    "reason": "HTTP fetch failed from 'uploads_clone': error from user's HttpBody stream: error reading a body from connection: error reading a body from connection: Missing files in the request: '1'."
                  }
                }
              ]
            }
