...
![Version: 2.6.2-rc.0](https://img.shields.io/badge/Version-2.6.2--rc.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.6.2-rc.0](https://img.shields.io/badge/AppVersion-v2.6.2--rc.0-informational?style=flat-square)
...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.6.2-rc.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.6.2-rc.0 --values my-values.yaml
```
