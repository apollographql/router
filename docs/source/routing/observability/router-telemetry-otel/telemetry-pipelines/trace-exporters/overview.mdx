...
The per-exporter `sampler` is available on `telemetry.exporters.tracing.otlp`, `telemetry.exporters.tracing.zipkin`, `telemetry.exporters.tracing.datadog`, and `telemetry.apollo`.
