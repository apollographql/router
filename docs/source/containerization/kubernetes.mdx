...
There is a complete [helm chart definition](https://github.com/apollographql/router/tree/v1.31.0-alpha.4/helm/chart/router) in the repo which illustrates how to use helm to deploy the router in kubernetes.
...
metadata:
  ...
  labels:
    helm.sh/chart: router-1.31.0-alpha.4
    app.kubernetes.io/name: router
    app.kubernetes.io/instance: release-name
    app.kubernetes.io/version: "v1.31.0-alpha.4"
    ...
    spec:
      ...
      containers:
        - name: router
          securityContext:
            {}
          image: "ghcr.io/apollographql/router:v1.31.0-alpha.4"
