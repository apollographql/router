---
title: Deploying router in Google Cloud Platform (GCP)
subtitle: ""
...
Not deploying to GCP? Try our deployment guides AWS or Azure.

</Note>

## Prerequisites

Before starting, set up the following tools:
