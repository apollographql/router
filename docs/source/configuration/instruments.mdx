...
Values of custom metrics can be extracted from the pipeline using [custom attributes](./custom-attributes). For example, to sum the contents of a request header, create a counter with value set as the request header:
