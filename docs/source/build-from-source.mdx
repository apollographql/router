...
If Apollo Router doesn't provide a [prebuilt executable](./quickstart/#1-download-and-extract-the-router-binary) for your system or architecture, you can build the executable from source.
...
That's it! Visit `localhost:4000` to open the [Apollo Studio Explorer](https://www.apollographql.com/docs/studio/explorer/). You can inspect the entire example federated graph and run your first queries against Apollo Router!
