...
If you want the router to consume entity events directly from NATS, Kafka, or Redis instead of receiving HTTP callbacks, use [event-stream-backed subscriptions](/graphos/routing/operations/subscriptions/event-streams/overview).
