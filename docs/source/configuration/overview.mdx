...
Additionally, since v1.43.1, the Apollo GraphOS Router can show a log when it detects that the client canceled the request. This log can be activated with:
