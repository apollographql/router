...
If the request includes the `read:others read:emails` scope set, then the router could successfully execute the entire query.

<ExpansionPanel title="Want to see more examples?">

Take the [authorization demo](https://apollo-router-auth-demo.fly.dev/graphql) for a whirl!
