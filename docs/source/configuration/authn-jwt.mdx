...
- 'poll_interval': **optional** interval in seconds at which the JWKS will be polled for changes. If not specified, the JWKS endpoint will be polled every 60 seconds.
</td>
</tr>
