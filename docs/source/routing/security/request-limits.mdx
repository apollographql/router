...
There is no default limit; every declared error is reported unless you configure this option, which matches how Apollo Router passes through subgraph errors.
