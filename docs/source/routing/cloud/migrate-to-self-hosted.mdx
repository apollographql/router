...
After you migrate all graphs to self-hosted mode, navigate to the Billing and Usage page and click the "Change plan" button to move your organization to a supported plan. See the [Plan Selection Troubleshooting page](https://support.apollographql.com/space/ETKB/2006712337/Plan+Selection+Troubleshooting) for more information.

<img
  className="screenshot"
  alt="Change plan button on the Billing and Usage page GraphOS Studio"
  src="../../images/billing_and_usage_change_plan.png"
/>
