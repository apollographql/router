...
This feature is available with any GraphOS plan. Rate limits apply on the Free plan.
See the [pricing page](https://www.apollographql.com/pricing) for details.
