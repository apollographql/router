...
In order to use [paid features](https://www.apollographql.com/docs/graphos/routing/graphos-features#graphos-router-features) of the Router, a GraphOS [plan](https://www.apollographql.com/pricing) is required. Learn more about [GraphOS Router features](/graphos/routing/graphos-features).
