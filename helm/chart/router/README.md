...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.16.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.16.0 --values my-values.yaml
```
