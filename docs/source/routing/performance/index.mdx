...
For globally distributed deployments, the [edge cache architecture guide](/graphos/routing/performance/caching/edge-cache-architecture) describes how to deploy routers with regional Redis instances, event-driven invalidation via pub/sub, and CDN integration.
