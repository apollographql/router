---
title: GraphOS Router v2.x Release Notes
description: About Apollo GraphOS Router version 2.x, including Long Term Release (LTS) status, key features, and how to upgrade
---
...
The new and updated capabilities of router v2.x include the following highlights.
