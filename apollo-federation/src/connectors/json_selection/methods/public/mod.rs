...
mod trim;
pub(crate) use trim::TrimEndMethod;
pub(crate) use trim::TrimMethod;
pub(crate) use trim::TrimStartMethod;
mod arithmetic;
...
mod with_connector_error;
pub(crate) use with_connector_error::WithConnectorErrorMethod;
