...
subtitle: Configure logging in the GraphOS Router
description: Configure logging in the Apollo GraphOS Router. Set the log level and output format.
---

The GraphOS Router provides built-in logging to capture records about the router's activity.
