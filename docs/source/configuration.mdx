...
opentelemetry:
  jaeger:
    # optional address of the jaeger UDP agent
    # if agent_endpoint and collector_endpoint are not specified, it will send traces
    # to the default Jaeger UDP agent address
