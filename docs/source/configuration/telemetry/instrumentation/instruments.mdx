...
Make sure to follow naming conventions for instruments. For reference, the [Open Telemetry semantic conventions](https://opentelemetry.io/docs/specs/semconv/general/metrics/) can help guide you to:
