...
This guide starts from a configuration that works with router v2.x. If you run router v1.x, first upgrade to v2.x by following [Upgrading from Versions 1.x](/graphos/reference/upgrade/from-router-v1), using a v2.x router to upgrade your configuration.
