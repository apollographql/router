...
By default, Rhai engine interns up to 256 strings. You can disable interning with the `intern_strings` configuration option:

```yaml title="config.yaml"
rhai:
  scripts: "./rhai"
  main: "main.rhai"
  intern_strings: false  # disable interning entirely
```

<Note>

**Pros of disabling string interning (`intern_strings: false`):**
