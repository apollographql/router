...
To use authorization directives in your subgraph schemas, you first need to enable them in your router. To do so, include the following in your router's [YAML config file](./overview/):
