...
You can set most environment variables via their [command-line option](#command-line-options) counterpart. The following values are only configureable as environment variables:
