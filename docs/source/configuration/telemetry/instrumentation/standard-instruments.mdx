---
title: GraphOS Router Instruments
subtitle: Standard metric instruments for a router's request lifecycle
description: Reference of standard metric instruments for the Apollo GraphOS Router's request lifecycle. Consumable via the router's metrics exporters. 
---

## Standard metric instruments

The GraphOS Router provides a set of non-configurable metric instruments that expose detailed information about the router's request lifecycle.
