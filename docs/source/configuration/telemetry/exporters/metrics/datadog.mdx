...
description: Configure the Datadog exporter for metrics via OpenTelemetry Protocol (OTLP) in the Apollo GraphOS Router.
---

Enable and configure the [OTLP exporter](./otlp) for metrics in the GraphOS Router for use with [Datadog](https://www.datadoghq.com/).
