...
Copy these configurations to get started. Before starting the collector, you'll need to set a `DD_API_KEY` environment variable to your Datadog API key.
...
If you don't see data in Datadog, see the [Troubleshooting](#troubleshooting) section below.
...
For more details, see [Router Metrics Configuration](/router/configuration/telemetry/exporters/metrics/overview) and [Router Tracing Configuration](/router/configuration/telemetry/exporters/tracing/overview).
...
### **[Configure router instrumentation](/graphos/routing/observability/router-telemetry-otel/apm-guides/datadog/router-instrumentation)**
- Add Datadog-specific span attributes, operation names, resource names, and error tracking to optimize APM views and dashboards
### [Configure Datadog dashboards](/graphos/routing/observability/apm-guides/datadog/observing-and-monitoring/dashboard-template)
- Add our out of the box dashboard template to your Datadog account for router monitoring
