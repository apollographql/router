...
**In Apollo Router v2.12.0 and earlier, these variables take precedence over your router telemetry settings and may cause traces or metrics to be sent to an unintended destination.
