...
- Redis-backed [response caching of subgraph responses](/graphos/routing/performance/caching/response-caching)
- Redis-backed [entity caching of subgraph responses](/graphos/routing/performance/caching/entity) (superseded by response caching)
