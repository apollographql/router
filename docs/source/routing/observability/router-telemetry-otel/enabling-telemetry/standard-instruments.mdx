...
See [Prometheus name changes](/graphos/routing/observability/router-telemetry-otel/apm-guides/prometheus/prometheus-metrics#prometheus-name-changes) for details on a set of duration and byte-count instruments that are dual-emitted under both their legacy and future Prometheus names.
