...
Set your router timeout to be greater than or equal to your subgraph timeouts. This enables the router to properly handle subgraph timeouts and return appropriate error responses to clients. Configure subgraph timeouts to be slightly lower than the router timeout to provide a buffer for the router to process the timeout response.
