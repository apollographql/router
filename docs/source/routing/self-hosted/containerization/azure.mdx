---
title: Deploying GraphOS Router to Azure
...
After setting up the prerequisite tools, build a router image with custom configuration:
...
## Push router image to Azure Container Registry
...
Congrats, you've successfully deployed the router with Azure!
