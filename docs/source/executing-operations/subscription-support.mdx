---
title: Configure federated subscription support
...
Subscription support is also available for cloud routers with a GraphOS Serverless or Dedicated plan. For cloud supergraphs, refer to [the cloud-specific docs](/graphos/operations/subscriptions).
