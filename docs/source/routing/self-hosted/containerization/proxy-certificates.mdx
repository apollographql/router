---
title: Add Proxy Certificates to Apollo Router Containers
...
The recommended approach is to build a custom Docker image with the certificate as described in [Building a custom image](#building-a-custom-image) and reference it in your Helm values.
