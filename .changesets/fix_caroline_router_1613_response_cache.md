### Correct no-store and no-cache behavior for response cache ([PR #8948](https://github.com/apollographql/router/pull/8948))
...
The response caching plugin was incorrectly treating `no-store` as both 'no serving response from the cache' and 'no storing response in the cache.'

This change fixes that behavior.

By [@carodewig](https://github.com/carodewig) in https://github.com/apollographql/router/pull/8948
