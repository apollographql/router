...
[OTLP (OpenTelemetry Protocol)](https://github.com/open-telemetry/opentelemetry-proto/blob/main/docs/specification.md) is the native protocol for Open Telemetry. It can be used to export traces over HTTP or gRPC to a variety of backends including:
