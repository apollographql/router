...
Redis configuration is done in the same way for APQ caching, query plan caching, [response caching](/router/configuration/response-caching), and [entity caching](/router/configuration/entity-caching).
