...
The Apollo Router applies a default limit of 30 seconds to receive the entire client request. The default limit of 30 seconds also applies for request between router to subgraphs. That limit is configurable:
