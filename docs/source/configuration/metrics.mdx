...
- `apollo_router_query_planning_duration` - Time spent planning queries in seconds (both for plan and warmup `phase`).
- `apollo_router_schema_loading_duration` - Time spent loading the schema.
