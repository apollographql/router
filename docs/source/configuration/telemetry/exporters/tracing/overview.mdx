...
subtitle: Collect tracing information from the GraphOS Router
description: Collect and export tracing information from the Apollo GraphOS Router. Supports OpenTelemetry Protocol (OTLP), Datadog, New Relic, Jaeger, Zipkin.
---

The GraphOS Router supports collection of traces with [OpenTelemetry](https://opentelemetry.io/), with exporters for:
...
* [Sending GraphOS Router traces and metrics to APM tools using OpenTelemetry](/technotes/TN0015-router-to-apm-via-opentelemetry/)
