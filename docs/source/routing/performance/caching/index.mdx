...
Apollo Router supports multiple caching strategies, including in-memory caching, distributed caching with Redis, and response caching, that enable you to reduce redundant subgraph requests and improve query latency.
