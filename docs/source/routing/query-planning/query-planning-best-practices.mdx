...
When working with Apollo Federation, changes in our schema can have unexpected impact on the complexity of our graph.
...
- Extensive use can exponentially increase the number of possible query plans generated, potentially leading to performance degradation at runtime as we generate uncached plans.
