...
- `apollo.router.query_planner.plan.duration` - Histogram of plan durations.
- `apollo.router.query_planner.total.duration` - Histogram of plan durations including queue time.
- `apollo.router.query_planner.queued` - A gauge of the number of queued plans requests.
