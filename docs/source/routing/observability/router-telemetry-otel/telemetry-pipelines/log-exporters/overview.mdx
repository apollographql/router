...
You can enable selective logging of these values using [standard events](../../enabling-telemetry/events#standard-events) with [conditions](../../enabling-telemetry/conditions).
...
| Attribute                        | Default | Description                                         |
|----------------------------------|---------|-----------------------------------------------------|
| `log_on_broken_pipe`   | false   | Emit a log message if a broken pipe was detected.   |
