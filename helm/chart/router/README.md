...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.0.0-rc.5
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.0.0-rc.5 --values my-values.yaml
```
