...
1. Fetch an offline license by running [`rover license fetch`](/rover/commands/license/#fetch-license) with the ID of the graph from which you want to fetch a license:
