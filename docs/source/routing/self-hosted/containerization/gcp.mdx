...
Not deploying on GCP? See our guides for deploying the router [locally in Docker](/graph)
...
1. On the **Container(s)** > **Edit Container** tab, update the following configurations:
    1. On the **Settings** tab:
        1. Set **Container port** to `4000`. This port must match your router's configuration for `supergraph.listen`.
