...
Instead, for most router customizations, Apollo recommends creating either a [Rhai script](/router/customizations/rhai/) or an [external coprocessor](/router/customizations/coprocessor/). Both of these customizations are supported by Apollo and provide strong separation of concerns and fault isolation.
