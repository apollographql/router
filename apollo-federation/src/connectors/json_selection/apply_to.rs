...
mod tests {
    ...
    fn test_left_associative_output_shapes() {
        ...
        let computed_batch_id = selection!("$batch.id").compute_output_shape(
            root_shape.clone(),
            &named_shapes,
            &SourceId::Other("JSONSelection".into()),
        );
        ...
        let computed_first = selection!("$batch.id->first").compute_output_shape(
            root_shape.clone(),
            &named_shapes,
            &SourceId::Other("JSONSelection".into()),
        );
        ...
        let computed_last = selection!("$batch.id->last").compute_output_shape(
            root_shape.clone(),
            &named_shapes,
            &SourceId::Other("JSONSelection".into()),
        );
