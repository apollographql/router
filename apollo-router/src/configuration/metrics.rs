...
impl InstrumentData {
    ...
    pub(crate) fn populate_config_instruments(&mut self, yaml: &serde_json::Value) {
        ...
        populate_config_instrument!(
            ...
            "$.traces.usage_reports.scheduled_delay",
            opt.traces.usage_reports.max_concurrent_exports,
            "$.traces.usage_reports.max_concurrent_exports",
            opt.traces.usage_reports.max_export_timeout,
            "$.traces.usage_reports.max_export_timeout",
            opt.metrics.otlp.exporter.scheduled_delay,
            "$.metrics.otlp.usage_reports.scheduled_delay",
            opt.metrics.otlp.max_export_timeout,
            "$.metrics.otlp.max_export_timeout",
            opt.metrics.usage_reports.exporter.scheduled_delay,
            "$.metrics.usage_reports.scheduled_delay",
            opt.metrics.usage_reports.max_concurrent_exports,
            "$.metrics.usage_reports.max_concurrent_exports",
            opt.metrics.usage_reports.max_export_timeout,
            "$.metrics.usage_reports.max_export_timeout"
        );
