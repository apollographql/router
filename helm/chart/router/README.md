...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.16.4
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.16.4 --values my-values.yaml
```
