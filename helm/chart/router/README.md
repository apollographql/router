...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.1.2
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.1.2 --values my-values.yaml
```
