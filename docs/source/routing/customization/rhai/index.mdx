...
For more advanced functionality — including network requests, writing to disk, injecting custom span data, or accessing external data — prefer using YAML configuration or [external co-processing](/router/customizations/coprocessor/) (an [Enterprise feature](/router/enterprise-features)).
