...
For details on hot reload support for different schema sources and performance considerations, see [Hot Reload](/graphos/routing/configuration/hot-reload-schema).
