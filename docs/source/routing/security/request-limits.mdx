...
Limit the total size of the header list for your incoming HTTP/2 requests.
The default value is 16KiB.

If the router receives a request whose headers exceed the allowed size, it responds to your client with `431 Request Header Fields Too Large`.
