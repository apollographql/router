...
- **APQ Enabled**: - Whether to use Automatic Persisted Queries (APQ) in subgraph calls.
...
traffic_shaping:
  ...
  subgraphs: # Rules applied to requests from the router to individual subgraphs
    products:
      ...
      apq_enabled: false # Do not use automatic persisted queries for http calls to 'products' subgraph. (true by default)
      experimental_retry:
