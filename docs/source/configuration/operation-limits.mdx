...
To use operation limits, you must run v1.17 or later of the GraphOS Router. [Download the latest version.](/router/quickstart#download-options)

You define operation limits in your router's [YAML config file](/router/configuration/overview/#yaml-config-file), like so:
...
You can enable or disable `warn_only` mode in your router's [YAML config file](/router/configuration/overview/#yaml-config-file), like so:
