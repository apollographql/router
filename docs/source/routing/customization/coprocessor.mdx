...
You can configure what you want to send from the context to your coprocessor. By default it's disabled (`none`) and doesn't send any context keys to the coprocessor. You now have the ability to give an array
