...
Start your observability journey with Datadog using Apollo's pre-configured dashboard template and router telemetry configuration.

## Install the dashboard template

To install the dashboard template to your Datadog account, follow these steps:
...
After you install the template, configure the template variables to match the appropriate tag values for your Runtime instances and ensure the relevant telemetry data is being sent to Datadog.
