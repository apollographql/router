...
pub(super) struct BaseQueryGraphBuilder {
...
impl BaseQueryGraphBuilder {
    ...
    pub(super) fn build(self) -> QueryGraph {
        self.query_graph
    }
    ...
    pub(super) fn mark_has_reachable_cross_subgraph_edges_for_ancestors(
        &mut self,
        from: NodeIndex,
    ) -> Result<(), FederationError> {
...
pub(super) struct SchemaQueryGraphBuilder {
    pub(super) base: BaseQueryGraphBuilder,
    pub(super) subgraph: Option<SchemaQueryGraphBuilderSubgraphData>,
    pub(super) for_query_planning: bool,
}

pub(super) struct SchemaQueryGraphBuilderSubgraphData {
...
impl SchemaQueryGraphBuilder {
    ...
    pub(super) fn build(mut self) -> Result<QueryGraph, FederationError> {
...
pub(super) fn resolvable_key_applications<'doc>(
