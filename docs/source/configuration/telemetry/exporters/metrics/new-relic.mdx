...
To configure the router, enable the [OTLP exporter](./opentelemetry#configuration) and set `temporality: delta`, `endpoint: <new-relic-endpoint>` and `api-key: <new-relic-api-key>`. For example: 
