...
![Version: 13.4.56-rc.0](https://img.shields.io/badge/Version-13.4.56--rc.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v13.4.56-rc.0](https://img.shields.io/badge/AppVersion-v13.4.56--rc.0-informational?style=flat-square)
...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 13.4.56-rc.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 13.4.56-rc.0 --values my-values.yaml
```
