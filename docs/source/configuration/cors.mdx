...
The default Apollo Router CORS behavior should suit your use case, and https://studio.apollographql.com/sandbox/explorer allows you to run queries against your Apollo Router.
You can always specify origins in your CORS configuration later. 

##  Configuring CORS options for Apollo Router
