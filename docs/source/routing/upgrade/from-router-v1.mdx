...
### Removed Jaeger tracing exporter and propagator

The `jaeger` exporter and the `propagation.jaeger` propagator have been removed, as Jaeger now fully supports the OTLP format.
