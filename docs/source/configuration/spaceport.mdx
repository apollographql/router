...
By default, the GraphQL client will be identified by the HTTP headers `apollographql-client-name` and `apollographql-client-version`. This can be overriden as follows:
