...
Once you enable this configuration, you can view enum and input usage along with other types of [field usage in GraphOS Studio](/graphos/metrics/field-usage).

<Note>

Once you enable `extended` reference reporting, there will be a lag in changes to metrics in Studio.
