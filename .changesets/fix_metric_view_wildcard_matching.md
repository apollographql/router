### Metric view names support `*`/`?` wildcards and catch-all patterns again ([PR #XXXX](https://github.com/apollographql/router/pull/XXXX))
...
By [@apollo-mateuswgoettems](https://github.com/apollo-mateuswgoettems) in https://github.com/apollographql/router/pull/XXXX
