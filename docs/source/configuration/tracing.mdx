...
> :warning: [Jaeger native is deprecated](https://opentelemetry.io/blog/2022/jaeger-native-otlp/) and will be removed in a future release of the Apollo Router. Instead, [Open Telemetry Collector](OpenTelemetry Collector via OTLP) should be used.
