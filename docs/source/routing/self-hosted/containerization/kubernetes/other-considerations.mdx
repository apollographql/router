...
## Using the Apollo GraphOS Operator
  ...
  For more advanced Kubernetes deployments, consider using the [Apollo GraphOS Operator](/docs/apollo-operator/) to manage your router and subgraph lifecycle. The Operator provides declarative Kubernetes resources for managing supergraphs and can simplify complex multi-service
  architectures.

  The Operator offers different [workflow patterns](/docs/apollo-operator/workflows/) depending on your infrastructure:
