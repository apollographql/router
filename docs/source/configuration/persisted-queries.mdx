...
If a router instance is set to [audit mode](#audit-mode-dry-run), its [logs](./logging) will include any operations it receives that haven't been added to the PQL.
