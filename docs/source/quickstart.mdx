...
That's it! Visit `localhost:4000` to open the [Apollo Studio Explorer](https://www.apollographql.com/docs/studio/explorer/). You can inspect the entire federated graph and run your first queries against Apollo Router!
