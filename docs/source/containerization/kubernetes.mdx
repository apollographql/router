...
There is a complete [helm chart definition](https://github.com/apollographql/router/tree/v1.13.0/helm/chart/router) in the repo which illustrates how to use helm to deploy the router in kubernetes.
