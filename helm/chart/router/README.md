...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.2.0
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.2.0 --values my-values.yaml
```
