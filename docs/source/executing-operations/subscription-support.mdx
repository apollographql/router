---
title: Configure subscription support
subtitle: Enable clients to receive real-time updates whenever new data becomes available
...
Subscription support is also available for routers in cloud supergraphs with a GraphOS Serverless or Dedicated plan. For cloud supergraphs, refer to [the cloud-specific docs](/graphos/operations/subscriptions).

</PremiumFeature>

The Apollo Router provides support for GraphQL subscription operations:
