...
![Version: 1.123.456](https://img.shields.io/badge/Version-1.123.456-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v1.123.456](https://img.shields.io/badge/AppVersion-v1.123.456-informational?style=flat-square)
...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.123.456
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.123.456 --values my-values.yaml
```
