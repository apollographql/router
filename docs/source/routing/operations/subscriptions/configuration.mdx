...
If your system already publishes entity changes to NATS, Kafka, or Redis, you can use an [event-stream-backed subscription](/graphos/routing/operations/subscriptions/event-streams/overview) instead of opening a subscription connection to the originating subgraph.
