...
import ExperimentalDiagnostics from '../../../shared/config/experimental_diagnostics.mdx';
...
Learn more in [Diagnostics (experimental)](/graphos/routing/self-hosted/diagnostics).
