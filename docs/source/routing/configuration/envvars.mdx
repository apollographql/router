...
This reference covers the environment variables, command-line options, and YAML configuration file properties for configuring an Apollo Router. 
...
The supported environment variables apply only if you're using GraphOS Router with [managed federation](/federation/managed-federation/overview/) and GraphOS Studio.
