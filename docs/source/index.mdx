...
- Extensive declarative [configuration options](/router/configuration/overview) (header propagation, CORS settings, OpenTelemetry support, and more)
- Support for [scripting](/router/customizations/rhai/) via the Rhai scripting language
- Advanced [GraphOS Enterprise features](/router/enterprise-features), including:
    - Real-time data via [GraphQL subscriptions](/router/executing-operations/subscription-support/)
    - [JWT authentication](/router/configuration/authn-jwt)
    - [Distributed caching](/router/configuration/distributed-caching/) for multi-router fleets
    - Customization in any language via [external coprocessing](/router/customizations/coprocessor/)
    - [Operation limits](/router/configuration/operation-limits/)
