...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 1.31.0-alpha.3
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 1.31.0-alpha.3 --values my-values.yaml
```
