...
If your organization uses a corporate proxy with TLS inspection, you must add the proxy's root certificate to the container. For details, see [Add proxy certificates](/graphos/routing/self-hosted/containerization/proxy-certificates).
